...
class GraphDijkstra {
    ...
    NodeDijkstra[] nodes; // Array para conter os nos

    GraphDijkstra(int n) {
        this.n = n;
        nodes = new NodeDijkstra[n + 1]; // +1 se os nos comecam em 1 ao inves de 0
        for (int i = 1; i <= n; i++)
            nodes[i] = new NodeDijkstra();
    }
...
public class Dijkstra {
    public static void main(String args[]) {
        ...
        GraphDijkstra g = new GraphDijkstra(in.nextInt());
        int e = in.nextInt();
        for (int i = 0; i < e; i++)
